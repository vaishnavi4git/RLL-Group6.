...
export class EngineersService {
  ...
  private regEngineerUrl: string =
    'http://localhost:2222/engineers/addEngineer';
  private logEngineerUrl: string = 'http://localhost:2222/engineers/login';
  private getAllEngineerMailsUrl: string =
    'http://localhost:2222/engineers/getAllEngineerMails';

  private getAllComplaintsByTicketIdUrl: string =
    'http://localhost:2222/complaints/getAllComplaintsByTicketIds';
  private updateStatusUrl: string =
    'http://localhost:2222/engineerDuty/updateStatus';
