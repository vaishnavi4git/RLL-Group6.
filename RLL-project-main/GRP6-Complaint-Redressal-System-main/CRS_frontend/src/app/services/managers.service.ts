...
export class ManagersService {
  ...
  private regManagerUrl: string = 'http://localhost:2222/managers/addManager';

  private logManagerUrl: string = 'http://localhost:2222/managers/login';

  private getAllComplaintsByPincodeUrl =
    'http://localhost:2222/managers/getAllComplaintsByPincode';

  private assignEngineersDutyUrl =
    'http://localhost:2222/engineerDuty/addEngineerDuty';
