...
export class AdminService {
  private getAllManagersUrl: string =
    'http://localhost:2222/managers/getAllManagers';
  private deleteManagerByEmailUrl: string =
    'http://localhost:2222/managers/deleteManager';
  private updateManagerUrl: string =
    'http://localhost:2222/managers/updateManager';

  private getAllEngineersUrl: string =
    'http://localhost:2222/engineers/getAllEngineers';
  private deleteEngineerByEmailUrl: string =
    'http://localhost:2222/engineers/deleteEngineer';

  private getAllCustomersUrl: string =
    'http://localhost:2222/customers/getAllCustomers';
  private deleteCustomerByEmailUrl: string =
    'http://localhost:2222/customers/deleteCustomer';
  private updateCustomerUrl: string =
    'http://localhost:2222/customers/updateCustomer';

  private getAllComplaintsUrl: string =
    'http://localhost:2222/complaints/getAllComplaints';
  private deleteComplaintByTicketIdUrl: string =
    'http://localhost:2222/complaints/deleteComplaintById';
  private updateComplaintUrl: string =
    'http://localhost:2222/complaints/updateComplaint';

  private getAllFeedbacksUrl: string =
    'http://localhost:2222/feedbacks/getAllFeedbacks';
  private deleteFeedbackByFeedbackIdUrl: string =
    'http://localhost:2222/feedbacks/deleteFeedbackById';
  private updateFeedbackUrl: string =
    'http://localhost:2222/feedbacks/updateFeedback';
